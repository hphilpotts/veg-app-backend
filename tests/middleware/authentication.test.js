...
describe("Authentication middleware test", () => {
    ...
    beforeEach(() => {
        ...
        mockRequest = { header: (headerKey) => mockRequest[headerKey] };
        ...
        mockResponse = {
            ...
            status: function (responseStatus) {
                ...
                return this; // allows for chaining - otherwise res.status(code).json(message) throws error
            },
            statusCode: null,
            message: null
        };
    ...
    it("should return a status of 500 if error occurs in try block", () => {
        ...
        expect(mockResponse.message).toBe("Server Error");
